...
class Data:
    ...
    def AreaGeometry(self) -> None:
        ...
        raise AttributeError(
            "AreaGeometry object cannot be changed, change RegKey instead."
        )
    ...
    def AreaGeometry(self) -> None:
        ...
        raise AttributeError(
            "AreaGeometry object cannot be deleted, change RegKey instead."
        )
    ...
    def Pharmacies(self) -> None:
        ...
        raise AttributeError(
            "Pharmacies object cannot be changed, change RegKey instead."
        )
    ...
    def Pharmacies(self) -> None:
        ...
        raise AttributeError(
            "Pharmacies object cannot be deleted, change RegKey instead."
        )
    ...
    def Customers(self) -> None:
        ...
        raise AttributeError(
            "Customers object cannot be changed, change RegKey instead."
        )
    ...
    def Customers(self) -> None:
        ...
        raise AttributeError(
            "Customers object cannot be deleted, change RegKey instead."
        )
