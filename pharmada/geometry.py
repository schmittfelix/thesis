...
class AreaGeometry:
    ...
    def regkey(self) -> None:
        ...
        raise AttributeError(
            "regkey attribute must not be changed, change the RegKey object instead."
        )
    ...
    def regkey(self) -> None:
        """Protect regkey from being deleted and warn user."""
        raise AttributeError(
            "regkey attribute must not be deleted, change the RegKey object instead."
        )
    ...
    def name(self) -> None:
        ...
        raise AttributeError(
            "name attribute must not be changed, change the RegKey object instead."
        )
    ...
    def name(self) -> None:
        ...
        raise AttributeError(
            "name attribute must not be deleted, change the RegKey object instead."
        )
    ...
    def osm_id(self) -> None:
        ...
        raise AttributeError(
            "osm_id attribute must not be changed, change the RegKey object instead."
        )
    ...
    def osm_id(self) -> None:
        ...
        raise AttributeError(
            "osm_id attribute must not be deleted, change the RegKey object instead."
        )
    ...
    def geometry(self) -> None:
        ...
        raise AttributeError(
            "geometry attribute must not be changed, change the RegKey object instead."
        )
    ...
    def geometry(self) -> None:
        ...
        raise AttributeError(
            "geometry attribute must not be deleted, change the RegKey object instead."
        )
    ...
    def precise_geometry(self) -> None:
        ...
        raise AttributeError(
            "precise_geometry attribute must not be changed, change the RegKey object instead."
        )
    ...
    def precise_geometry(self) -> None:
        ...
        raise AttributeError(
            "precise_geometry attribute must not be deleted, change the RegKey object instead."
        )
